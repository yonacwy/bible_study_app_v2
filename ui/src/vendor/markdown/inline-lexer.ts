...
export class InlineLexer {
  protected static rulesBase: RulesInlineBase = null as any;
  /**
   * Pedantic Inline Grammar.
   */
  protected static rulesPedantic: RulesInlinePedantic = null as any;
  /**
   * GFM Inline Grammar
   */
  protected static rulesGfm: RulesInlineGfm = null as any;
  /**
   * GFM + Line Breaks Inline Grammar.
   */
  protected static rulesBreaks: RulesInlineBreaks = null as any;
  protected rules: RulesInlineBase | RulesInlinePedantic | RulesInlineGfm | RulesInlineBreaks = null as any;
  protected renderer: Renderer;
  protected inLink: boolean = null as any;
  protected hasRulesGfm: boolean = null as any;
  protected ruleCallbacks: RulesInlineCallback[] = null as any;
  ...
  output(nextPart: string): string {
    ...
    if(this.options.escape === undefined) return "";
